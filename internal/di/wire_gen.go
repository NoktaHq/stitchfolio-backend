...
func InitApp(ctx *context.Context) (*app.App, error) {
	...
	expenseTrackerService := service.ProvideExpenseTrackerService(expenseTrackerRepository, mapperMapper, responseMapper, fileStoreService, entityDocumentService)
